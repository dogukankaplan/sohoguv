...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Professional Neutral Palette - Inspired by Tailwind UI Pro
        'slate': {
          50: '#F8FAFC',
          100: '#F1F5F9',
          200: '#E2E8F0',
        ...
        // Accent Color - Sophisticated Teal (Security/Trust)
        'accent': {
          50: '#F0FDFA',
          100: '#CCFBF1',
          200: '#99F6E4',
        ...
        // Secondary - Warm Amber (Call-to-Action)
        'amber': {
          50: '#FFFBEB',
          100: '#FEF3C7',
          200: '#FDE68A',
      ...
      boxShadow: {
        ...
        'accent-glow': '0 0 0 3px rgba(20, 184, 166, 0.1)',
