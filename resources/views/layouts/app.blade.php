...
<body class="h-full flex flex-col">
    ...
    <footer class="bg-slate-950 border-t border-slate-800" aria-labelledby="footer-heading">
        ...
        <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
            ...
            <div class="grid grid-cols-2 gap-8 xl:grid-cols-4">
                ...
                <div>
                    ...
                    <ul role="list" class="mt-6 space-y-4">
                        @if(isset($globalServices))
                            ...
                            <li><a href="{{ route('services.show', $service->slug) }}" class="text-sm leading-6 text-slate-400 hover:text-soho-teal transition">{{ $service->title }}</a></li>
                            @endforeach
                        @endif
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul role="list" class="mt-6 space-y-4">
                        <li><a href="{{ route('requests.fault') }}" class="text-sm leading-6 text-slate-400 hover:text-soho-teal transition">Arıza Talebi</a></li>
                        <li><a href="{{ route('requests.inventory') }}" class="text-sm leading-6 text-slate-400 hover:text-soho-teal transition">Envanter Talebi</a></li>
                        <li><a href="{{ route('contact') }}" class="text-sm leading-6 text-slate-400 hover:text-soho-teal transition">İletişim Formu</a></li>
                    </ul>
                </div>
            ...
            <div class="mt-16 border-t border-slate-800 pt-8 sm:mt-20 lg:mt-24 flex flex-col sm:flex-row justify-between items-center">
                ...
                <div class="flex space-x-6 mt-4 sm:mt-0">
                    ...
                    <a href="{{ $globalSettings['facebook'] }}" class="text-slate-500 hover:text-soho-teal transition" target="_blank">
                    ...
                    <a href="{{ $globalSettings['instagram'] }}" class="text-slate-500 hover:text-soho-teal transition" target="_blank">
                    ...
                    <a href="{{ $globalSettings['linkedin'] }}" class="text-slate-500 hover:text-soho-teal transition" target="_blank">
