                        ...
                        <div class="card-modern bg-gray-50">
                            ...
                            <div class="space-y-4">
                                <a href="tel:{{ setting('phone') }}"
                                    class="flex items-center gap-3 p-4 rounded-2xl bg-white border border-gray-200 hover:border-brand-500 transition group">
                                    <div
                                        class="w-10 h-10 rounded-full bg-brand-50 flex items-center justify-center group-hover:bg-brand-500 transition">
                                        <svg class="w-5 h-5 text-brand-600 group-hover:text-white transition" fill="none"
                                ...
                                <a href="{{ route('contact') }}"
                                    class="flex items-center gap-3 p-4 rounded-2xl bg-white border border-gray-200 hover:border-accent-500 transition group">
                                    <div
                                        class="w-10 h-10 rounded-full bg-accent-50 flex items-center justify-center group-hover:bg-accent-500 transition">
                                        <svg class="w-5 h-5 text-accent-600 group-hover:text-white transition" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
